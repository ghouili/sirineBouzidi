...
const Pay = ({ setPayed }) => {
  const { openPay, setOpenPay, setOpenCart, openCart } = useContext(GeneralContext);
  ...
  return (
    <Transition.Root show={openPay} as={Fragment}>
      ...
      >
        ...
        <div className="fixed -top-6 right-1/3 z-10 overflow-x-auto mx-auto">
              ...
              <Dialog.Panel className="flex w-full transform text-left text-base transition md:my-8 md:max-w-2xl md:px-4 lg:max-w-4xl">
                <Card className="w-full max-w-[24rem]">
                  <CardHeader
                    ...
                    floated={false}
                    shadow={false}
                    className="m-0 grid place-items-center rounded-b-none py-4 px-2 text-center h-28"
                  >
                    <img src={Logo} className="h-2/3 w-auto" alt="" />
                  </CardHeader>
                  <CardBody>
                    <Tabs value={type} className="overflow-visible">
                      ...
                      >
                        <TabPanel value="card" className="p-0">
                          <form className="mt-12 flex flex-col gap-4 w-80 ">
                            {/* <div>
                              <Typography
                                variant="small"
                                color="blue-gray"
                        ...
                        <TabPanel value="paypal" className="p-0 w-full">
                          <form className="w-80 mt-12 flex flex-col gap-4">
                            <div>
                              <Typography
                                variant="small"
                                color="blue-gray"
