...
const Navbar = () => {
  ...
  return (
    <div className="h-14 border-b flex flex-row items-center justify-between bg-white shadow-md">
      {/* left side */}
      {!user || user.role === "user" ? (
      ...
      <div className="flex flex-row items-center gap-3 pr-7">
        ...
        <div className=" p-2.5 rounded-full cursor-pointer hover:bg-blue-50 text-gray-600 hover:text-blue-400">
          <IoMdExpand size={22} />
        </div>
        <div className=" p-2.5 rounded-full cursor-pointer hover:bg-blue-50 text-gray-600 hover:text-blue-400">
          <BiMoon size={22} />
